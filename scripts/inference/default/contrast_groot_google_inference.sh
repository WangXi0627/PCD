...
# ==============================
# GR00T + original PCD grounded_sam_tracking Google runner
# wx: PCD + GR00T-N1.6-fractal + original ContrastImageGenerator + ContrastDecoding
# ==============================
...
# Make original PCD modules importable by the GR00T/SimplerEnv python.
...
# PCD original runner is serial per env. Use n_envs=1 to be closest and avoid
# loading several grounded_sam_tracking generators at once.
N_ENVS=1
N_ACTION_STEPS=1
SAVE_VIDEO=False
...
RUN_NAME="groot_pcd_original_google_ep${N_EPISODES}_env${N_ENVS}_act${N_ACTION_STEPS}_rep${PCD_NUM_REPEATS}_alpha${PCD_ALPHA}_by${PCD_BY}_inpaint${PCD_INPAINT_MODE}_video${SAVE_VIDEO}"
